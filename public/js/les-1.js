...
/***/ "./resources/assets/js/lessen/les-1.js":
...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('task-list', {
    template: '\n        <div>\n            <task v-for="task in tasks">{{ task.task }}</task>\n        </div>\n    ',

    data: function data() {
        return {
            tasks: [{ task: 'Go to the store', complete: true }, { task: 'Finish screencast', complete: false }, { task: 'Make donation', complete: false }, { task: 'Clear inbox', complete: false }, { task: 'Make dinner', complete: false }, { task: 'Clean room', complete: true }]
        };
    }
});
...
module.exports = __webpack_require__("./resources/assets/js/lessen/les-1.js");
